...
nohup env DEBUG="verdaccio:storage*,verdaccio:proxy*,verdaccio:plugin:local-storage" npx verdaccio@next-7 --config ./config.yml --listen $TEST_CASE_PROXY >debug.log 2>error.log &
